// ======================================================================
// ADC_filtre_samlet_grader.v generated from TopDesign.cysch
// 05/11/2016 at 11:32
...
module ADC_SAR_SEQ_P4_v2_30_1 (
	...
	cy_clock_v1_0
		#(.id("42f520f9-f45b-4f62-976d-5b52e440091e/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
...
module top ;
	...
	wire [0:0] tmpOE__Y2_net;
	wire [0:0] tmpFB_0__Y2_net;
	wire [0:0] tmpIO_0__Y2_net;
	wire [0:0] tmpINTERRUPT_0__Y2_net;
	electrical [0:0] tmpSIOVREF__Y2_net;

	cy_psoc3_pins_v1_10
		#(.id("680a4ef0-a5d3-4935-972c-ff782d5080bd"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		Y2
		 (.oe(tmpOE__Y2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Y2_net[0:0]}),
		  .analog({Net_526}),
		  .io({tmpIO_0__Y2_net[0:0]}),
		  .siovref(tmpSIOVREF__Y2_net),
		  .interrupt({tmpINTERRUPT_0__Y2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Y2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__EMG_net;
	wire [0:0] tmpFB_0__EMG_net;
	wire [0:0] tmpIO_0__EMG_net;
	wire [0:0] tmpINTERRUPT_0__EMG_net;
	electrical [0:0] tmpSIOVREF__EMG_net;

	cy_psoc3_pins_v1_10
		#(.id("ce0cc937-a96e-4969-acad-878e06229d62"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		EMG
		 (.oe(tmpOE__EMG_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__EMG_net[0:0]}),
		  .analog({Net_528}),
		  .io({tmpIO_0__EMG_net[0:0]}),
		  .siovref(tmpSIOVREF__EMG_net),
		  .interrupt({tmpINTERRUPT_0__EMG_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__EMG_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("2baa80af-1fc6-4973-89c8-5a9a00c87876"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("3e761e47-4a06-4770-892d-e1f75a2ba85e"),
		  .source_clock_id(""),
		  .divisor(0),
