...
\subsection{Formål}
Denne test har til formål at identificere spændingen i henholdsvis $1^{\circ}$ og $90^{\circ}$, hvorudfra vinkler kan beregnes. Derudover identificeres %støjsignaler i outputsignalet samt 
