...
% Omskriv
% Skal måle vinklen i forhold til knæets vinkel. Placering på ydersiden af låret. Èn af planerne x,y,z. (X eller Y) 
% Kalibrering består af at offsettet trækkes fra. 
...
% Hvor placeres accelerometeret??? Et sted står der lateralt på låret (afsnittes før, linje 70) og linje 85/herover, står noget andet. - Ydersiden af låret
\end{itemize}
...
% Laves færdigt. 
% forsøget samlet med EMG-forstærker sammen med Accelerometer. 
% Accelerometeret fungerer som en stop klods. 
