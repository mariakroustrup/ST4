...
\begin{figure}[H]
	...
	\label{fig:emgfft}
\end{figure}
Der er foretaget en frekvensanalyse af baseline målingerne for at identificere støjsignaler. Dette ses af \autoref{fig:emgfft}, hvor der yderligere ses en frekvensanalyse af 2. måling for identificering af frekvensområdet for bevægelsen. 
Der ses ingen støjsignaler på signalet, udover en dc-komponent ved $0~Hz$. Derudover er det ikke muligt at se, hvorvidt der er $50~Hz$ støj af signalet, da der er samplet med $100~Hz$, hvor nyquist-frekvensen er $50~Hz$. Herudover viser frekvensanalysen ikke amplituden af $50~Hz$ støj, dog antages den for at være tilstede, da dette er en kendt støjfaktor. Af frekvensanalysen for 2. måling identificeres frekvensområdet som værende relativt lavfrekvent, $0-2~Hz$. Dette kan relateres til, at EMG-forstærkeren anvendt i pilotforsøget, besidder et aktivt lavpasfilter til udgaltning, der har en cut frekvens på $1,94~Hz$ \fxmote{Skal der refereres til afsnittet om sensorer?? Synes at da at EMG-forstærkerens knækfrekvens skal præsenteres sammen med EMG-forstærkeren efter systembeskrivelsen! OBS!! knæk-frekvensen er også beskrevet i "opsummeringen" til sidst i pilotforsøget!!!} 
...
Det ønskes at se, hvorledes målte spændinger fra acceleromeret, repræsenterer vinklen over knæet. Dette formås ud fra følgende formler, hvor spændingensværdierne udregnes til et udtryk for vinklen: 
...
For at kunne se relationen mellem udslag i EMG samt for accelerometere bedre, plottes begge disse målinger på samme graf. Dette ses af \autoref{fig:emgogacc}. 
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\textwidth]{figures/Pilotforsoeg/???.png}
	\caption{Vinkel og acc}
