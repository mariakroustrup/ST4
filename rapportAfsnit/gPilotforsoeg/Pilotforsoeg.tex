...
\begin{itemize}
\item Sammenligning af muskelaktivitet oprejst og bevægelsen af en squat-øvelse 
\end{itemize}
\item Identificering af støjsignaler \fxnote{Hvordan?}
...
\caption{Placering af accelerometrene på låret samt underbenet. Disse placeringer er markeret med grå. \fxnote{Tvivl om billedet. Stiplede linje?? Hmm skal vi have alle akserne på? Skal vi fjerne den? Vi bruger vel alle tre akser nu???} }
