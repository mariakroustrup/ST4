...
I det præsenterede data tages der udgangspunkt i forsøgsperson 1, og er som følge af at målingerne for forsøgsperson er påvirket af muskelrystelser. Til trods for muskelrystelserne ses der ligheder mellem målingerne for forsøgspersonerne. 
...
\begin{figure}[H]
	...
	\label{fig:accfftx}
\end{figure}
Af \autoref{fig:accfftx} ses frekvensanalysen for accelerometeret i x-aksen. Ud fra dette er ses der ingen støjsignaler ud over en dc-komponent der er dæmpet ved $0,1~Hz$. Grundet sampligsfrekvensen ses der ingen $50~Hz$, hvortil årsagen er beskrevet under frekvensanalysen for EMG-målingen. 

Spændingerne fra accelrometeret repræsentere vinklerne for femur og tibia i hver af tre akser. Denne spændingsværdi ønskes omregnet grader, for således at undersøge vinklen af knæet. Til at omregne spændingen til grader benyttes følgende formler:
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\textwidth]{figures/Pilotforsoeg/blackbox}
