...
\begin{figure}[H]
	...
	\caption{EMG-målinger af baseline samt 2. måling for forsøgsperson 1.}
	\label{fig:baselineogemg}
\end{figure}
Ud fra illustration set af \autoref{fig:baselineogemg}, ses en stigning muskelaktivitet under udførslen af 2. måling i forhold til baseline. Idet forsøgspersonen har været i nedadgående bevægelse, ses dette som stigningen i EMG-signalet. Ligeledes ses der ved opadgående bevægelse et fald i EMG-målingen.       
