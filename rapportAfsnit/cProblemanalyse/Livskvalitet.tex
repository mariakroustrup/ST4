...
%\label{livskvalitet}
%\begin{tabular}{lll}
%\begin{tabular}[c]{@{}l@{}} \textbf{Europæisk \\livskvalitets vurdering} \end{tabular} & \multicolumn{2}{l}{\textbf{Moderate eller alvorlige problemer målt ud fra Europæisk livskvalitets vurdering}} \\ \cline{2-3} 
