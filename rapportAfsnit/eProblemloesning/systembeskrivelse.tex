...
\subsection{Blokdiagram} \label{sec:blokdiagram} \fxnote{ADC: Hvad hvis drift betyder offset og ADC'en ikke kan anvendes fordi den går i mætning?} \fxnote{Sker der den samme digitale behandling af begge signaler?}
\begin{figure}[H]
\centering
