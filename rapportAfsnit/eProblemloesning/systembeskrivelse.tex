...
\subsection{Blokdiagram} \label{sec:blokdiagram} \fxnote{OPMÆRKSOM PÅ: Hvis ADC'ens drift betyder offset og ADC'en ikke kan anvendes fordi den går i mætning? - Er dette relevant?} 
\begin{figure}[H]
\centering
