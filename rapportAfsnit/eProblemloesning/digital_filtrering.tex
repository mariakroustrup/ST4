...
\begin{figure} [H]
\centering
\includegraphics[width=1\textwidth]{figures/problemloesning/lavpas_knaek.pdf}
...
\begin{figure} [H]
\centering
\includegraphics[width=1\textwidth]{figures/problemloesning/lavpas_orden.pdf}
...
\caption{De blå linjer på grafen viser resultater fra pilotforsøget. De røde linjer på hver graf viser et moving average filter med filterlængde på hhv. 10, 15 og 20.}
...
\textbf{Krav:}
\begin{itemize}
\item Skal muliggøre en repræsentativ aflæsning af vinklerne. 
\item Skal have en filterlængde på $10~Hz$
\item Skal have en acceptabel forsinkelse
\end{itemize}