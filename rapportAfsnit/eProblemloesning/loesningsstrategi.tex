\section{Løsningsstrategi} \label{sec:loesningsstrategiiiii}
...
Ud fra dette sæt er der udvalgt de nødvendige komponenter, således der kan fortages analog til digital konvertering af de signaler, der måles via EMG-forstærker samt acceleromtrene. Yderligere skal systemet være i stand til at kommunikere trådløst med andre enheder, hvilket er muligt ved anvendelse af Bluetooth Low Energy (BLE).

I \autoref{fig:CY8CKIT-042}, ses de valgte komponenter, der består af et CY8CKIT-042 BLE Pioneer baseboard, som fremover vil refereres til som en mikrokontroller. Derudover et CY8CKIT-142 PSoC 4 BLE modul. %, der vil refereres til som et BLE-modul, hvilket har en operationsfrekvens på  $2,4~GHz$. 

\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{figures/CY8CKIT-042.png}
\caption{CY8CKIT-042 BLE Pioneer baseboard samt CY8CKIT-142 PSoC 4 BLE modulet, hvilket ses markeret \citep{cypresspsoc2015}.}
\label{fig:CY8CKIT-042}
\end{figure}

Baseboardet er platformen, hvorpå EMG-forstærkeren samt accelerometre tilkobles, og hvor de analoge signaler konverteres til digitale signaler. Baseboardet har mulighed for tilkobling af en spændingsforsyning, bestående af et batteri, eller via mikro USB tilslutningen \citep{cypressguide2014}.
