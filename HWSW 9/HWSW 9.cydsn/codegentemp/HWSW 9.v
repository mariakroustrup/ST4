// ======================================================================
// HWSW 9.v generated from TopDesign.cysch
// 04/04/2016 at 11:11
...
module ADC_SAR_SEQ_P4_v2_30_1 (
	...
	cy_psoc3_pins_v1_10
		#(.id("42f520f9-f45b-4f62-976d-5b52e440091e/05a9c8de-3ba2-4909-8250-95fdc61c0bf4"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("dc8cee34-7130-4060-adc4-59d6526ee173"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a3746495-c570-4ee6-b82b-589fc6f50f0d"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
